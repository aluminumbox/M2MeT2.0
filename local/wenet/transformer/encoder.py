...
class BaseEncoder(torch.nn.Module):
    ...
    def forward(
        ...
        for layer in self.encoders:
            xs, chunk_masks, _, _ = layer(xs, embedding, chunk_masks, pos_emb, mask_pad)
    ...
    def __init__(
        ...
        self.encoders = torch.nn.ModuleList([
            ConformerEncoderLayer(
                ...
                PositionwiseFeedForward(256, linear_units, dropout_rate, odim=output_size) if i == 0 else None,
                dropout_rate,
                normalize_before,
                concat_after,
